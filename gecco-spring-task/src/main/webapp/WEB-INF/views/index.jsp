    ...
    <div id="mainLayout" class="easyui-layout hidden" data-options="fit: true">
        ...
        <div data-options="region: 'west', title: '菜单导航栏', iconCls: 'icon-standard-map', split: true, minWidth: 200, maxWidth: 400" style="width: 220px; padding: 1px;">
            <div id="myMenu" class="easyui-accordion" data-options="fit:true,border:false">
					...
					<div>
						<a id="btn" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-hamburg-full-time'" style="width:98%;margin-bottom:5px;" onclick="window.mainpage.mainTabs.addModule('妹子图','${ctx}/scheduleJob','icon-hamburg-full-time')">妹子图任务</a>
					</div>
					<div>
						<a id="btn" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-hamburg-future'" style="width:98%;margin-bottom:5px;" onclick="window.mainpage.mainTabs.addModule('妹子图','${ctx}/scheduleJob/quartzCron','icon-hamburg-future')">cron表达式生成</a>
					</div>
				</div>
			</div>
        </div>
